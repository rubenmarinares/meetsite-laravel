...
class AcademiaRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'nif'=>['required','string','max:200'],
            'razonsocial'=>['required','string','max:400'],
            'domiciliofiscal'=>['required','string','max:400'],
    ...
    public function messages()
    {
        return [
            ...
            'nif.required'=>__('academia.nif_required'),
            'razonsocial.required'=>__('academia.razonsocial_required'),
            'domiciliofiscal.required'=>__('academia.domiciliofiscal_required'),
