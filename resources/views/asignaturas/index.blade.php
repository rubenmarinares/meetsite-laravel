<x-app-layout>
    ...
    <div class="card mb-3">
        <div class="card-header d-flex align-items-center justify-content-between">
            <h4 class="card-title"><i class="fas fa-school"></i>&nbsp;Asignaturas</h4>
            <div class="card-header-action">
                <a href="{{route('asignaturas.create')}}" class="btn btn-sm btn-primary ajax-sidepanel"><i class="fa-solid fa-plus"></i>&nbsp;Nuevo</a>
            </div>
        </div>
        ...
        <table id="tablelist" class="table table-striped table-bordered dataTable">
            <thead>
                ...
                <tbody>
                    ...
                    <tr class="">                                
                        <td class="" >                            
                            <a href="{{route('asignaturas.edit',$asignatura->id)}}" title="Editar" class="btn btn-sm btn-primary"><i class="fa-solid fa-pencil"></i></a> 
                            <button 
            ...
            <div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="deleteModalLabel">Eliminar Asignatura</h5>
                    ...
                    <div class="modal-footer">
                        <form action="{{route('asignaturas.destroy',$asignatura)}}" method="POST" class="inline" id="deleteForm">
                            @csrf
                            @method('DELETE')
            ...
            <!--FIN MODAL CONFIRMACIÓN-->            
                <script>
                function openDeleteModal(asignatura) {                                                
