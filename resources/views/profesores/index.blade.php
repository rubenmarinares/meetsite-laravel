<x-app-layout>
    ...
    <div class="card mb-3">
        <div class="card-header d-flex align-items-center justify-content-between">
            <h4 class="card-title"><i class="fas fa-school"></i>&nbsp;Profesores</h4>
            <div class="card-header-action">
                <a href="{{route('profesores.create')}}" class="btn btn-sm btn-primary ajax-sidepanel"><i class="fa-solid fa-plus"></i>&nbsp;Nuevo</a>
            </div>
        </div>
        ...
        <table id="tablelist" class="table table-striped table-bordered dataTable">
            <thead>
                ...
                <tbody>
                    ...
                    <tr class="">                                
                        <td class="" >                            
                            <a href="{{route('profesores.edit',$profesor->id)}}" title="Editar" class="btn btn-sm btn-primary"><i class="fa-solid fa-pencil"></i></a> 
                            <button 
