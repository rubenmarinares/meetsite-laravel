<form class="needs-validation" action="{{ $actionUrl }}" method="POST" novalidate>
    ...
    <ul class="nav nav-tabs invoice-tab border-bottom mb-3" id="academiaTab" role="tablist">
        <li class="nav-item" role="presentation">
            <button class="nav-link active" id="academias-tab-0" data-bs-toggle="tab" data-bs-target="#academias-tab-0-pane" type="button" role="tab" aria-controls="analytics-tab-0-pane" aria-selected="true">
    ...
    <div class="tab-content">
        <!--PANEL ACADEMIAS-->
        <div class="tab-pane fade active show" id="academias-tab-0-pane" role="tabpanel" aria-labelledby="academias-tab-0" tabindex="0">
            ...
            <div class="row mb-3 mt-3">
                ...
                <div class="col-md-6">
                    <label for="razonsocial" class="form-label">{{ __('academia.razonsocial')}} *</label>
                    <input name="razonsocial" id="razonsocial" class="form-control @error('razonsocial') is-invalid @enderror" value="{{ old('razonsocial', $academia->razonsocial) }}">
                    @error('razonsocial')
                        <div class="invalid-feedback d-block">{{ $message }}</div>
                    @enderror
                </div>
                <div class="col-md-6">
                    <label for="nif" class="form-label">{{ __('academia.nif')}} *</label>
                    <input name="nif" id="nif" class="form-control @error('nif') is-invalid @enderror" value="{{ old('nif', $academia->nif) }}">
                    @error('nif')
                        <div class="invalid-feedback d-block">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="row mb-3 mt-3">
                <div class="col-md-6">
                    <label for="Domicilio Fiscal" class="form-label">{{ __('academia.domiciliofiscal')}} *</label>
                    <textarea name="domiciliofiscal" id="domiciliofiscal" rows="5" class="form-control @error('domiciliofiscal') is-invalid @enderror">{{ old('domiciliofiscal', $academia->domiciliofiscal) }}</textarea>
