        ...
        <table id="tablelist" class="table table-striped table-bordered dataTable">
            <thead>
                ...
                <tbody>
                    ...
                    <tr class="">                                
                        <td class="" >                            
                            <a href="{{route('clientes.edit',$cliente->id)}}" title="Editar" class="btn btn-sm btn-primary"><i class="fa-solid fa-pencil"></i></a> 
                            <button 
            ...
            <div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    ...
                    <div class="modal-footer">
                        <form action="{{route('clientes.destroy',$cliente)}}" method="POST" class="inline" id="deleteForm">
                            @csrf
                            @method('DELETE')
